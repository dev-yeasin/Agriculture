...
<pre>
Job Title: Create a website for “Agricultural Information Hub” using HTML, CSS & JavaScript.
Conditions:

Work must be carried out in a safe manner and according to coding standards.

Open-source resources can be used.

Written code must be clean & error free.
Equipment:

Personal computer / laptop
Software: Web browser and Text editor
Job Objective: The objective of this job is to create an Agricultural Information Hub that serve a
comprehensive resource for farmers and agriculture enthusiasts. The hub will provide farming
guides, detailed crop information, pest control strategies, and a means for users to contact
...
or documents. Contact information is also provided for direct communication with agricultural
extension services.
